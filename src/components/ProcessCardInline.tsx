...
interface ProcessCardInlineProps {
  id: string;
  onProcessMerged: (process: Process) => void;
}

const ProcessCardInline: React.FC<ProcessCardInlineProps> = ({
  id,
  onProcessMerged,
}) => {
...
export default ProcessCardInline;
